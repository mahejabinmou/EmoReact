    ...
    <div className="sectionGap">
      <div>
        ...
        <p className="ourServicePara">
          Do you want to live in a place full of comfort and convenience, where
          electricity is produced by itself and you also save on it? With us it
          can come true faster than you.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 justify-between items-center pb-[10px]">
            <div className="joysSliderImgParent relative ">
              <img
                ...
                src="https://res.cloudinary.com/dshn2s0tc/image/upload/v1719474791/advanceCare/doctorOne_g8kwet.jpg"
                alt=""
              />
            </div>
