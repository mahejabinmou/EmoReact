...
const JoyCardOneHero = () => {
  ...
  return (
    <div>
      <div>
        <div
          className='bg-[url("https://res.cloudinary.com/dshn2s0tc/image/upload/v1719302380/advanceCare/mHeroContact_bfrsw9.png")]
          ...
          <div className="heroImgParent hidden">
            <div>
              ...
              <p className=" heroImgContentPara ">
                ...
                service <FaAngleRight></FaAngleRight> Joys of Living
              </p>
            </div>
          </div>
        </div>
